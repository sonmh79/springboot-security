...
import com.example.sstest.auth.domain.RestAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .httpBasic().disable()
                .authorizeRequests()
                .antMatchers("/api/v1/auth/members/access-token").permitAll()
                .antMatchers("/api/v1/auth/members/**").authenticated()
